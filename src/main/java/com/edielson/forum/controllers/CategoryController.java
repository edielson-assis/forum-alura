...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<Page<CategoryResponseDTO>> findAll(@PageableDefault(size = 10, sort = {"id"}) Pageable pageable) {
    ...
    @PutMapping(value = "/{id}") 
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Void> update(@Valid @PathVariable Long id, @RequestBody CategoryDTO categoryDTO) {
